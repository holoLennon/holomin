...
app.config(function($stateProvider, $urlRouterProvider,$logProvider,ENV) {
    ...
    $stateProvider
        ...
        .state('tab', {
            url: "/tab",
            abstract: true,
            templateUrl: "views/pub_d/tabs.html",  //[ccc差别]
            controller: 'tabCtrl'
        })
      //我的
      .state('tab.my', {
        ...
        views: {
          'tab-d': {
            templateUrl: 'views/tab_d-d/my.html',
            controller: 'myCtrl'
          }
        }
      })
      ...
      .state('tab.Wwwhome', {
        ...
        views: {
          'tab-a': {
            ...
            templateUrl: 'views/tab_d-a/Wwwhome.html'
      ...
      .state('tab.RA_DoctorList', {
        url: '/RA_DoctorList/:productchannelId',
        views: {
          'tab-a': {
     ...
     */
      .state('tab.RA_receiveWay', {
        ...
        views: {
          'tab-c': {
            templateUrl: 'views/tab_d-c/receiveWay.html',
            controller: 'OrderrCtrl'
          }
        }
      })
