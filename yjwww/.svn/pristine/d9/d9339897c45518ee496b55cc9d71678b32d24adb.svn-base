...
app.config(function($stateProvider, $urlRouterProvider,$logProvider,ENV) {
    ...
    $stateProvider
        ...
        .state('tab', {
            url: "/tab",
            abstract: true,
            templateUrl: "views/pub_tcm/tabs_c.html",
            controller: 'tabCtrl'
        })
        ///////////////////////a
      //首页
      .state('tab.DoctorList', {
        ...
        views: {
          'tab_c-a': {
            templateUrl: 'views/tab_g-a/DoctorList.html',
      ...
      .state('tab.RA_Doctor', {
          ...
          views: {
            'tab_c-a': {
              templateUrl: 'views/tab_g-a/Doctor.html',
        ...
        .state('tab.RA_DoctorListSearch', {
          ...
          views: {
            'tab_c-a': {
              templateUrl: 'views/tab_g-a/DoctorListSearch.html',
      ...
      .state('tab.RA_SalesmanQrcode', {
        ...
        views: {
          'tab_c-a': {
            templateUrl: 'views/tab_g-a/SalesmanQrcode.html',
      ...
      .state('tab.CloudPharmacy', {
        ...
        views: {
          'tab_c-b': {
            templateUrl: 'views/tab_g-b/CloudPharmacy.html',
      ...
      .state('tab.RB_StoreProduct', {
        ...
        views: {
          'tab_c-b': {
            templateUrl: 'views/tab_g-b/StoreProduct.html',
      ...
      .state('tab.Drugstore', {
        ...
        views: {
          'tab_c-c': {
            templateUrl: 'views/tab_g-c/Drugstore.html',
      ...
      .state('tab.Mystore', {
        ...
        views: {
          'tab_c-d': {
            templateUrl: 'views/tab_g-d/Mystore.html',
      ...
      .state('tab.RD_Editseller', {
        ...
        views: {
          'tab_c-d': {
            templateUrl: 'views/tab_g-d/Editseller.html',
            controller: 'SalesmanCtrl'
          }
        }
      })
      ...
      .state('tab.RD_Userinfo', {
        ...
        views: {
          'tab_c-d': {
            templateUrl: 'views/tab_g-d/Userinfo.html',
      ...
      .state('tab.RD_Setting', {
        ...
        views: {
          'tab_c-d': {
            templateUrl: 'views/tab_g-d/Setting.html',
            controller: 'MystoreCtrl'
          }
        }
      })
      ...
      .state('tab.RD_yijian', {
        ...
        views: {
          'tab_c-d': {
            templateUrl: 'views/tab_g-d/yijian.html'
          }
        }
      })
      //服务页
      .state('tab.RD_fuwu', {
        ...
        views: {
          'tab_c-d': {
            templateUrl: 'views/tab_g-d/fuwu.html',
            controller: 'MystoreCtrl'
          }
        }
      })
