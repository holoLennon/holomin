 ...
 * DruggistList，药剂师列表
 */
appctrl.controller('DruggistListCtrl', function($scope, $rootScope,$log,$timeout,
                                                $ionicTabsDelegate, $ionicPopover, $ionicModal, $ionicLoading,
                                                $location, $state,
                                                $cordovaNetwork, $cordovaGoogleAnalytics,
                                                Storage,
                                                ENV,DruggistService,CommonService) {
     ...
     * @param  药师对象
     */
    $scope.yaoshizixun=function(){
        CommonService.alertm('咨询药师：请电话咨询').then(function (res) {});
    };
    $scope.init();
    ctrlReinitMap.remove('DruggistListCtrl');
